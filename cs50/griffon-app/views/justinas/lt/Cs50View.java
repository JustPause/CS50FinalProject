...
public class Cs50View extends AbstractSwingGriffonView {
    private Cs50Model model;
    private Cs50Controller controller;

    @MVCMember
    public void setModel(@Nonnull Cs50Model model) {
        this.model = model;
    }

    @MVCMember
    public void setController(@Nonnull Cs50Controller controller) {
    ...
    private Image getImage(String path) {
        return Toolkit.getDefaultToolkit().getImage(Cs50View.class.getResource(path));
    }
}